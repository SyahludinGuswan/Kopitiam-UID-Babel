...
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| `User_App_Mobile`  | Kode UIW, Kode UP3, Kode ULP, ULP, Username, Role, Bidang, Tim, Sub-Tim, Akses Menu                                                                                                | Sumber profil dan otorisasi operasional; tidak menyimpan password        |
