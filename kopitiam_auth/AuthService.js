...
function authVerifyEnvelope_(envelope) {
  ...
  try {
    ...
    return authFail_('AUTH_REQUEST_INVALID', 'Payload internal tidak valid.');
  }
}
...
function authHmacBytes_(secret, bytes) { return Utilities.computeHmacSha256Signature(bytes, String(secret)); }
